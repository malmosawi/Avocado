...
$sqlOrder="SELECT * from `order` WHERE `order_status` = 3  ";
$querOrder=mysqli_query($con, $sqlOrder);
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="example" class="table table-striped table-bordered text-nowrap w-100">
											<thead>
												<tr>
													<th class="wd-15p">رقم الطلب</th>
													<th class="wd-15p">اسم الزبون</th>
													<th class="wd-20p">رقم الهاتف</th>
													<th class="wd-15p">تاريخ ووقت الطلب</th>
													<th class="wd-10p">المبلغ الكلي للطلب</th>
													<th class="wd-10p">حالة الطلب</th>
													<th class="wd-10p">عرض تفاصيل الطلب</th>
												</tr>
											</thead>
											<tbody>
												<?php
												
												while( $row = mysqli_fetch_assoc($querOrder)){
													echo '
														
														<tr>
															<td>'.$row['order_num'].'</td>
															<td>'.$row['cust_name'].'</td>
															<td>'.$row['cost_phone'].'</td>
															<td>'.$row['date_order'].'</td>
															<td>'.number_format($row['total_amount']).' $</td>
															<td>تم التأكيد</td>
															<td><a href="order_detils.php?order='.$row['order_id'].'">عرض</a></td>
														</tr>
													';
												}
