...
if(isset($_POST['send'])){
    ...
    $subject = $_POST['yourname'].'  -  '.$_POST['youremail'];
    $message = $_POST['yourmessage'];
    $from = $_POST['youremail'] ;
    
    

    $to      = 'info@avocado-iq.com';
    $headers = array(
        'From' => 'info@avocado-iq.com',
...
<head>
    ...
    <title>Contacts Avocado</title>

    <link rel='stylesheet' id='wc-block-vendors-style-css' href='../wp-content/cache/wpfc-minified/dtjg9569/4plcs.css'
    ...
    <link rel='stylesheet' id='elementor-global-css' href='../wp-content/cache/wpfc-minified/7m48h754/4plcs.css'
        type='text/css' media='all' />
    <link rel='stylesheet' id='elementor-post-440-css'
        href='../wp-content/uploads/elementor/css/post-440f282.css?ver=1627314264' type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='nimbus-main-css' href='../wp-content/cache/wpfc-minified/2z9bkz5v/4plcs.css'
        ...
        .woocommerce form .form-row .select2-container--default .select2-selection--single .select2-selection__arrow b {
            border-color: #e25e33 transparent transparent transparent;
        }
...
<body
    class="page-template-default page page-id-440 theme-nimbus woocommerce-no-js elementor-default elementor-kit-1353 elementor-page elementor-page-440">
                                        ...
                                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-e917ec1"
                                            ...
                                            <div class="elementor-column-wrap elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                        ...
                                                        <div class="elementor-widget-container">
                                                            <nav class='primary-nav'>
                                                                <ul id="menu-main" class="menu">
                                                                    ...
                                                                    <li id="menu-item-479"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-440 current_page_item menu-item-479">
                                                                        <a href="index.php"><span><span
                                                    ...
                                                    <div class="elementor-element elementor-element-a9864c4 elementor-align-right elementor-icon-list--layout-inline elementor-widget elementor-widget-wgl-header-list-info"
                                                        data-id="a9864c4" data-element_type="widget"
                                                        ...
                                                        <div class="elementor-widget-container">
                                                            <nav class='primary-nav'>
                                                                <ul id="menu-main-1" class="menu">
                                                                    ...
                                                                    <li
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-501">
                                                                        <a href="../about-me/index.php"><span><span
                                                                                    class="item_text">About
                                                                                    us</span></span>
                                                                        </a>
                                ...
                                <div class="header_area_container">
                                    <nav class='primary-nav' style="height:100px;">
                                        <ul id="menu-main-2" class="menu">
                                            ...
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-214">
                        ...
                        <div class='wgl-menu-outer_content'>
                            ...
                            <nav class="primary-nav">
                                <ul id="menu-main-3" class="menu">
                                    ...
                                    <li
                                        class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item menu-item-479 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor">
                                        <a href="index.php"><span><span
                                                    class="item_text">Contacts</span></span><i
    ...
    <div class="page-header page-header_align_center"
        style="background-image: url(../wp-content/uploads/2020/02/Contact.png); background-size:cover; background-repeat:no-repeat; background-attachment:scroll; background-position:center bottom;background-color: #202020; height: 350px; margin-bottom: 50px; padding-top: 76px; padding-bottom: 80px;">
        <div class="page-header_wrapper">
            <div class="wgl-container">
                <div class="page-header_content">
                    <h1 class="page-header_title" style="opacity:0;color: #ffffff; font-size: 48px; line-height: 52px;">
                        Contacts
                    </h1>
                ...
                <div id="main-content" class="wgl_col-12">
                    <div data-elementor-type="wp-page" data-elementor-id="440" class="elementor elementor-440"
                        ...
                        <div class="elementor-inner">
                            <div class="elementor-section-wrap">
                                <section
                                    class="elementor-section elementor-top-section elementor-element elementor-element-3529c8e elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                    data-id="3529c8e" data-element_type="section">
                                    <div class="elementor-container elementor-column-gap-default">
                                        <div class="elementor-row">
                                            <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-a4ea626"
                                                data-id="a4ea626" data-element_type="column">
                                                <div class="elementor-column-wrap elementor-element-populated">
                                                    <div class="elementor-widget-wrap">
                                                        <div class="elementor-element elementor-element-668b17e elementor-widget elementor-widget-spacer"
                                                            data-id="668b17e" data-element_type="widget"
                                ...
                                <section
                                    class="elementor-section elementor-top-section elementor-element elementor-element-bc778cf elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                    data-id="bc778cf" data-element_type="section">
                                    <div class="elementor-container elementor-column-gap-default">
                                        <div class="elementor-row">
                                            <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-b0fafad"
                                                data-id="b0fafad" data-element_type="column">
                                                <div class="elementor-column-wrap elementor-element-populated">
                                                    <div class="elementor-widget-wrap">
                                                        <div class="elementor-element elementor-element-8bfa9cd elementor-widget elementor-widget-spacer"
                                                            data-id="8bfa9cd" data-element_type="widget"
                                                            data-widget_type="spacer.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="elementor-spacer">
                                                                    <div class="elementor-spacer-inner"></div>
                                                        ...
                                                        <div class="elementor-element elementor-element-1a31543 aleft subtitle-suspended elementor-widget elementor-widget-wgl-double-headings"
                                                            data-id="1a31543" data-element_type="widget"
                                                            data-widget_type="wgl-double-headings.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="wgl-double_heading">
                                                                    <div class="dbl__subtitle">contacts</div><a
                                                                        class="dbl__link">
                                                                        <h3 class="dbl__title-wrapper"><span
                                                                                class="dbl__title">Quick Support</span>
                                                                        </h3>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="elementor-element elementor-element-f7845ab elementor-widget elementor-widget-text-editor"
                                                            data-id="f7845ab" data-element_type="widget"
                                                            data-widget_type="text-editor.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="elementor-text-editor elementor-clearfix">
                                                                    <p>These are the words we live by in everything we
                                                                        do. Every story we tell,
                                                                        and every interaction we create</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="elementor-element elementor-element-3894a24 aleft elementor-widget-icon-box wgl-icon-box elementor-view-default elementor-widget elementor-widget-wgl-info-box"
                                                            data-id="3894a24" data-element_type="widget"
                                                                    ...
                                                                    <div class="wgl-infobox_wrapper wgl-layout-left">
                                                                        ...
                                                                        <div class="content_wrapper">
                                                                            <div class="wgl-infobox-title_wrapper">
                                                                                <h3 class="wgl-infobox_title">Call us :</h3>
                                                                            </div>
                                                                            <div class="wgl-infobox_content"><p>+964 773 877 5557</p>
</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="elementor-element elementor-element-d7e16c1 aleft elementor-widget-icon-box wgl-icon-box elementor-view-default elementor-widget elementor-widget-wgl-info-box"
                                                            data-id="d7e16c1" data-element_type="widget"
                                                            data-widget_type="wgl-info-box.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="wgl-infobox">
                                                                    <div class="wgl-infobox_wrapper wgl-layout-left">
                                                                        <div class="media-wrapper icon-wrapper"><span
                                                                                class="wgl-icon"><i
                                                                                    class="icon elementor-icon flaticon flaticon-mail"
                                                                                    aria-hidden="true"></i></span></div>
                                                                        <div class="content_wrapper">
                                                                            <div class="wgl-infobox-title_wrapper">
                                                                                <h3 class="wgl-infobox_title">info@avocado-iq.com</h3>
                                                                            </div>
                                            ...
                                            <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-b281eb7"
                                                data-id="b281eb7" data-element_type="column"
                                                data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                <div class="elementor-column-wrap elementor-element-populated">
                                                    <div class="elementor-widget-wrap">
                                                        <div class="elementor-element elementor-element-8717a5f aleft elementor-widget elementor-widget-wgl-double-headings"
                                                            data-id="8717a5f" data-element_type="widget"
                                                            data-widget_type="wgl-double-headings.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="wgl-double_heading"><a class="dbl__link">
                                                                        <h3 class="dbl__title-wrapper"><span
                                                                                class="dbl__title">Get in Touch</span>
                                                                        </h3>
                                                                    </a></div>
                                                            </div>
                                                        </div>
                                                        <div class="elementor-element elementor-element-4f9ca6c elementor-widget elementor-widget-spacer"
                                                            data-id="4f9ca6c" data-element_type="widget"
                                                            data-widget_type="spacer.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="elementor-spacer">
                                                                    <div class="elementor-spacer-inner"></div>
                                                        ...
                                                        <div class="elementor-element elementor-element-dc5f335 elementor-widget elementor-widget-shortcode"
                                                            data-id="dc5f335" data-element_type="widget"
                                                            data-widget_type="shortcode.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="elementor-shortcode">
                                                                    <div role="form" class="wpcf7"
                                                                        id="wpcf7-f465-p440-o1" lang="en-US" dir="ltr">
                                                                        ...
                                                                        <form action="" method="post"
                                                                            ...
                                                                            <div class='row input-bg-white'>
                                                                                <div class='wgl_col-12'>
                                                                                    <span
                                                                                        class="wpcf7-form-control-wrap text-759"><input
                                                                                ...
                                                                                <div class='wgl_col-12'>
                                                                                    <span
                                                                                        class="wpcf7-form-control-wrap email-613"><input
                                                                                            type="email"
                                                                                            name="youremail" value=""
                                                                                            size="40"
                                                                                ...
                                                                                <div class='wgl_col-12'>
                                                                                    <span
                                                                                        class="wpcf7-form-control-wrap textarea-876"><textarea
                                                                                            name="yourmessage"
                                                                                            cols="40" rows="10"
                                                                            ...
                                                                            <p><span class="wgl-button has-morph"><input
                                                                                        type="submit"
                                                                                        name="send"
    ...
    <script type='text/javascript' src='../wp-content/themes/nimbus/js/jquery.appear8a54.js?ver=1.0.0'
