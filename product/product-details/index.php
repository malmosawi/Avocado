                    ...
                    <div id="product-1814"
                        ...
                        <div class="summary entry-summary">
                                                                            ...
                                                                            <del aria-hidden="true">
                                                                                <span class="woocommerce-Price-amount amount">
                                                                                    <bdi>
                                                                                        ...
                                                                                        '.number_format($product['last_price']).'
                                                                                    </bdi>
                                                                                </span>
                                                                            </del>
                                                                            <ins>
                                                                        ...
                                                                        <p class="price">
                                                                            <span class="woocommerce-Price-amount amount">
                                                                                <bdi>
                                                                                    ...
                                                                                    '.number_format($product['product_price']).' د.ع
                                                                                </bdi>
                                                                            </span>
                                                                        </p>
                                                                ';
                            ...
                            <!-- <p class="price">
                                    <span class="woocommerce-Price-amount amount">
                                        <bdi>
                                            <span class="woocommerce-Price-currencySymbol"></span>
                                                <?php echo $product['product_price'] ; ?> د.ع 
                                        </bdi>
                                    </span>
                                </p> -->
                        ...
                        <div class="woocommerce-tabs wc-tabs-wrapper">
                            <ul class="tabs wc-tabs" role="tablist">
                                <li class="description_tab" id="tab-title-description" role="tab"
                                    ...
                                    <a href="#tab-description">
                                        Description <br> الوصف </a>
                                </li>
                                 <li class="reviews_tab" id="tab-title-reviews" role="tab" aria-controls="tab-reviews">
                                    <a href="#tab-reviews">
                                      How to take <br> طريقة الأستخدام   </a>
                                </li> 
                                
                                <li class="additional_information_tab" id="tab-title-additional_information" role="tab"
                                    aria-controls="tab-additional_information">
                                    <a href="#tab-additional_information">
                                    Ingredients <br> المكونات </a>
                                </li>
                            ...
                            <div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content wc-tab"
                             ...
                             <div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--reviews_tab panel entry-content wc-tab"
                                id="tab-reviews" role="tabpanel"
                                aria-labelledby="tab-title-reviews_tab">
                                <h2>How to take</h2>
                                <p>
                                    <?php echo $product['using_pro'] ; ?>
                                </p>
        ...
        function addTocart(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#con-"+ id +"").append('\
                        <br><br>\
                        <h6 style="color: #16ba16;">تم اضافة المنتج الى العربة بنجاح</h6>');
                },
