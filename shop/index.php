...
$sql_prod="SELECT * from `products` WHERE `show` = 1 ";
$quer_prooo=mysqli_query($con, $sql_prod);
            ...
            <div class="row sidebar_left">
                <div id='main-content' class="wgl_col-12">
                    ...
                    <div class="wgl-products-catalog wgl-products-wrapper columns-3">
                        <ul class="wgl-products appear-animation anim-slide-left">
                            <?php 
                             $i = 0 ;
                                ...
                                while( $row = mysqli_fetch_assoc($quer_prooo)) {
                                    ...
                                    // echo $row['rank'].' - ';
                                    // $rank_new =  $row['rank'] * 10  ;
                                    // echo '<br>'; 
                                   
                                    if( $row['offer'] == 0){
                                          $priceDetils = '<span class="price">
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol"></span>
                                                            '.number_format($row['product_price']).' د.ع
                                                        </bdi>
                                                    </span>
                                                </span>';
                                    }else{
                                    ...
                                    echo '
                                        <li class="product type-product post-9 status-publish first instock product_cat-sweatshirt product_tag-clothes product_tag-design has-post-thumbnail shipping-taxable purchasable product-type-simple">
                                            <div class="woo_product_image shop_media">
                                                <div class="picture  no_effects">
                                                    <a class="woo_post-link" href="../product/product-details/index.php?product='.$row['product_id'].'">
                                                        <img width="540" height="700" src="../product_img/'.$row['photo1'].'"
                                                    ...
                                                    <div id="con-'.$row['product_id'].'">
                                                        <button id="'.$row['product_id'].'" onclick="addTocart(this.id)" style="border-radius: 10px;margin-top: 0%;height: 53px;background-color: #e25e33;margin-bottom: 14%;color: white;" class="product_cart button product_type_simple add_to_cart_button ajax_add_to_cart" >
                                                            Add to cart
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="woo_product_content">
                                                <h2 class="woocommerce-loop-product__title">
                                                    <a href="../product/product-details/index.php?product='.$row['product_id'].'" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                        '.$row['product_name'].'
                                                    </a>
                                                </h2>
                                    ...
                                    ';
                                    // $rank = 0 ;
                                    // The rating before priceDetils 
                                    //  <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                    //                 <span style="width:'.($row['rank']*10).'%">
                        ...
                        <div id="woocommerce_product_tag_cloud-2" class="widget nimbus_widget woocommerce widget_product_tag_cloud">
